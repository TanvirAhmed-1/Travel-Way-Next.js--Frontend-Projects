...
interface Booking {
  ...
  booking_states: "Accept" | "Pending" | "Rejected" | string;
  description: string;
  total_days: number;
  price: number;
  ratings: number;
...
// AuthContext type (adjust if you already have types)
          ...
          >
            ...
            <div className="p-6 space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
                <div>
                  <p>
                    <strong>Days:</strong> {b.total_days}
                  </p>
                  <p>
                    <strong>Price:</strong> ৳ {b.price}
                  </p>
                  <p>
                    <strong>Ratings:</strong> {b.ratings}
                  </p>
                  <p>
                    <strong>Places:</strong> {b.places}
                  </p>
                </div>
                <div>
                  <p>
                    <strong>Tour Manager:</strong> {b.tour_manager} (
                    {b.tour_manager_contact})
                  </p>
                  <p>
                    <strong>Guide:</strong> {b.guide_name} ({b.guide_contact})
                  </p>
                  <p>
                    <strong>Things to carry:</strong> {b.things_to_carry}
                  </p>
                </div>
              </div>
